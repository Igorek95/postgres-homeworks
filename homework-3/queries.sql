...
SELECT customers.company_name as customer_name, CONCAT(employees.first_name, ' ', employees.last_name) FROM orders
...
-- 4. уникальные названия продуктов, которых заказано ровно 10 единиц (количество заказанных единиц см в колонке quantity табл C)
